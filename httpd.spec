...
#Install httpd.service systemd unit
mkdir -p $RPM_BUILD_ROOT/usr/lib/systemd/system/
mkdir -p $RPM_BUILD_ROOT/etc/sysconfig/
install -m644 /nfshome/grajangam/httpd.service \
        $RPM_BUILD_ROOT/usr/lib/systemd/system/httpd.service
install -m644 /nfshome/grajangam/httpd_environment_file \
...
%attr(0644,root,root) /usr/lib/systemd/system/httpd.service
%attr(0644,root,root) /etc/sysconfig/httpd
